...
<body>
	...
	<section class="wishlist">
		...
		<h1 class="title">Sản phẩm có trong danh sách thích</h1>
   ...
   ?>
			<form action="" method="POST" class="box">
				<a href="wishlist.php?delete=<?= $fetch_wishlist['id']; ?>" class="fas fa-times"
					onclick="return confirm('Chắc chứ?');"></a>
				<a href="view_page.php?pid=<?= $fetch_wishlist['pid']; ?>" class="fas fa-eye"></a>
				<img src="uploaded_img/<?= $fetch_wishlist['image']; ?>" alt="">
				<div class="name"><?= $fetch_wishlist['name']; ?></div>
				<div class="price"><?= number_format($fetch_wishlist['price'], 0, ',', ','); ?> VNĐ</div>
   ...
   ?>
		...
		<div class="wishlist-total">
			...
			<a href="shop.php" class="option-btn">Mua sắm tiếp</a>
			<a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>">Xoá hết</a>
		</div>
