...
<body>
			...
			<div class="flex">
				<div class="inputBox">
					...
					<select name="category" class="box" required>
						...
						<option value="other">Động vật nhỏ</option>
					</select>
				</div>
				<div class="inputBox">
					<input type="number" min="0" name="price" class="box" required
						placeholder="Nhập giá tiền (VD: 200000)">
					<input type="file" name="image" required class="box" accept="image/jpg, image/jpeg, image/png"
						placeholder="Chọn ảnh">
				</div>
			</div>
			<textarea name="details" class="box" required placeholder="Nhập thông tin sản phẩm" cols="30"
				rows="10"></textarea>
   ...
   ?>
			<div class="box">
				...
				<div class="flex-btn">
					<a href="admin_update_product.php?update=<?= $fetch_products['id']; ?>" class="option-btn">Cập
						nhật</a>
					<a href="admin_products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn"
						onclick="return confirm('có muốn xoá chứ?');">Xóa</a>
				</div>
			</div>
			<?php
      }
